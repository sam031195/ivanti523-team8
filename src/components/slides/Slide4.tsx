        ...
        {failures.map((f) => (
          <StaggerItem key={f.cis}>
            <div className="s1-feature-item">
              ...
              <ul className="text-[0.7875rem] text-muted-foreground leading-relaxed mb-4 space-y-1.5 list-none">
                {f.bullets.map((b, i) => (
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="text-[0.7875rem] text-destructive/50">{f.consequence}</p>
              </div>
            </div>
          </StaggerItem>
        ))}
